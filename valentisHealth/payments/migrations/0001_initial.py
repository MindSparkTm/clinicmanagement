# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2018-01-25 12:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.DecimalField(decimal_places=0, max_digits=5)),
                ...
                ('authority_type', models.DecimalField(decimal_places=0, max_digits=3)),
                ('ward', models.DecimalField(decimal_places=0, max_digits=2)),
                ('available_limit', models.DecimalField(decimal_places=2, max_digits=10)),
                ('admit_days', models.DecimalField(decimal_places=0, max_digits=3)),
                ('reserve', models.DecimalField(decimal_places=2, max_digits=10)),
                ('notes', models.CharField(max_length=200)),
                ('anniv', models.DecimalField(decimal_places=0, max_digits=5)),
                # ('auth_batch_no', models.DecimalField(decimal_places=0, max_digits=5)),
                ('day_bed_charge', models.DecimalField(decimal_places=2, max_digits=10)),
                ('date_admitted', models.DateField(default=datetime.date.today)),
                ('code', models.DecimalField(decimal_places=0, max_digits=7)),
            ],
            options={
                'ordering': ('-created',),
            },

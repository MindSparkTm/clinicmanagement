    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='children', to=settings.AUTH_USER_MODEL, verbose_name='patient_no')),
            ],
            options={
                'verbose_name': 'child',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank='True', max_length=30, null='True')),
                ('age', models.CharField(blank='True', max_length=30, null='True')),
                ('patient_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medication', to=settings.AUTH_USER_MODEL, verbose_name='patient_no')),
            ],
            options={
                'verbose_name': 'child',
                'verbose_name_plural': 'children',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('if_smoker', models.CharField(blank='True', max_length=30, null='True')),
                ...
                ('if_chew_tobacco', models.CharField(blank='True', max_length=30, null='True')),
                ('yrs_chewing_tobacco', models.CharField(blank='True', max_length=30, null='True')),
                ('if_quit_before', models.CharField(blank='True', max_length=30, null='True')),
                ('tobacco_quit_duration', models.CharField(blank='True', max_length=30, null='True')),
                ('if_drink_alcohol', models.CharField(blank='True', max_length=30, null='True')),
                ...
                ('if_drug_used', models.CharField(blank='True', max_length=30, null='True')),
                ...
                ('if_exercise', models.CharField(blank='True', max_length=30, null='True')),
                ('exercise_freq', models.CharField(blank='True', max_length=30, null='True')),
                ('if_special_diet', models.CharField(blank='True', max_length=30, null='True')),
                ('special_diet', models.TextField(blank='True', max_length=100, null='True')),
                ('if_use_caffein', models.CharField(blank='True', max_length=30, null='True')),
                ('caffein_daily_amt', models.CharField(blank='True', max_length=30, null='True')),
                ('is_sadder', models.CharField(blank='True', max_length=30, null='True')),
                ('if_lost_interest', models.CharField(blank='True', max_length=30, null='True')),
                ('have_will', models.CharField(blank='True', max_length=30, null='True')),
            ],
            options={
                'ordering': ('last_updated',),
            },
